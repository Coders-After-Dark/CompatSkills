...
public class CompatSkillConstants {
    ...
    public static final String VERSION = "1.12.2-1.10.0";
    public static final String DEPENDENCIES = "required-after:reskillable@[1.9.0,);after:baubles;after:bloodmagic@[1.12.2-2.3.0-98,);after:gamestages;after:immersiveengineering;" +
